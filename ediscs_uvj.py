...
def f1059(f_Ha,rf_J,rf_U,rf_V,rf_VJ,rf_UV):
    plt.figure(figsize=(18, 16), dpi= 80, facecolor='w', edgecolor='k')
    plt.subplot(2,2,1)
    f = open('/Users/jennifercooper/Documents/Gal_Ev/EDisCS/G102/clusters/1059-1253/field_match.txt', 'r')
    lines = f.readlines()[1:]
    f.close()
...
def f1138(f_Ha,rf_J,rf_U,rf_V,rf_VJ,rf_UV):
    plt.figure(figsize=(18, 16), dpi= 80, facecolor='w', edgecolor='k')
    plt.subplot(2,2,1)
    f = open('/Users/jennifercooper/Documents/Gal_Ev/EDisCS/G102/clusters/1138_1133/field_match.txt', 'r')
    lines = f.readlines()[1:]
    f.close()
...
def f1227(f_Ha,rf_J,rf_U,rf_V,rf_VJ,rf_UV):
    plt.figure(figsize=(18, 16), dpi= 80, facecolor='w', edgecolor='k')
    plt.subplot(2,2,1)
    f = open('/Users/jennifercooper/Documents/Gal_Ev/EDisCS/G102/clusters/1227-1138/field_match.txt', 'r')
    lines = f.readlines()[1:]
    f.close()
...
def f1301(f_Ha,rf_J,rf_U,rf_V,rf_VJ,rf_UV):
    plt.figure(figsize=(18, 16), dpi= 80, facecolor='w', edgecolor='k')
    plt.subplot(2,2,1)
    f = open('/Users/jennifercooper/Documents/Gal_Ev/EDisCS/G102/clusters/1301-1139/field_match.txt', 'r')
    lines = f.readlines()[1:]
    f.close()
